...
declare type DT = (Api<any> | JQueryDataTableApi | DataTable<any> | JQueryDataTableJq) &
    ...
    { fnFilter( input: string, column_number?: number | string, regex?: boolean, smart?: boolean, showGlobal?: boolean, caseInsensitive?: boolean ): void };
...
declare namespace DataTables {
    ...
    export interface JQueryDataTableJq extends JQueryDataTables {
        /** @deprecated Since 1.10. Use `isDataTable`. */
        fnIsDataTable(table: string | Node | JQuery | DataTables.Api): boolean;
    ...
    export interface ObjectSelectorModifier {
        /**
    ...
    export interface CoreMethods extends UtilityMethods {
        /**
         * Get jquery object
         */
    ...
    export interface AjaxMethods extends Api {
        /**
    ...
    export interface AjaxMethodModel {
        /**
    ...
    export interface PageMethodeModelInfoReturn {
        page: number;
        pages: number;
        start: number;
        end: number;
    ...
    export interface StateReturnModel {
        time: number;
        start: number;
        length: number;
    ...
    export interface StateReturnModelColumns {
        search: SearchSettings;
        visible: boolean;
    }
    ...
    export interface CommonSubMethods {
        /**
    ...
    export interface CommonCellMethods extends CommonSubMethods {
        /**
    ...
    export interface CellMethods extends CoreMethods, CommonCellMethods {
        /**
         * Get data for the selected cell
         */
        data(): any;
    ...
    export interface CellIndexReturn {
        row: number;
        column: number;
        columnVisible: number;
    }

    export interface CellsMethods extends CoreMethods, CommonCellMethods {
        /**
    ...
    export interface CommonColumnMethod extends CommonSubMethods {
        /**
    ...
    export interface ColumnMethodsModel {
        /**
    ...
    export interface ColumnMethods extends CoreMethods, CommonColumnMethod {
        /**
    ...
    export interface ColumnsMethodsModel {
        /**
         * Select all columns
         *
         * @param Option used to specify how the cells should be ordered, and if paging or filtering in the table should be taken into account.
    ...
    export interface ColumnsMethods extends CoreMethods, CommonColumnMethod {
        /**
    ...
    export interface CommonRowMethod extends CommonSubMethods {
        /**
         * Obtain the th / td nodes for the selected column
         *
    ...
    export interface RowChildMethodModel {
        /**
    ...
    export interface RowChildMethods extends CoreMethods {
        /**
         * Hide the child row(s) of a parent row
         */
        hide(): Api;
    ...
    export interface RowMethodsModel {
        /**
    ...
    export interface RowMethods extends CoreMethods, CommonRowMethod {
        /**
         * Order Methods / object
         */
    ...
    export interface RowsMethodsModel {
        /**
         * Select all rows
         *
         * @param Option used to specify how the cells should be ordered, and if paging or filtering in the table should be taken into account.
    ...
    export interface RowsMethods extends CoreMethods, CommonRowMethod {
        /**
    ...
    export interface TableMethods extends CoreMethods {
        /**
    ...
    export interface TablesMethods extends CoreMethods {
        /**
    ...
    export interface ObjectOrderFixed {
        /**
         * Two-element array:
    ...
    export interface StaticRenderFunctions {
        /**
    ...
    export interface objectTablesStatic {
        /**
    ...
    export interface ColumnDefsSettings extends ColumnSettings {
    ...
    export interface LanguagePaginateSettings {
        first: string;
        last: string;
        next: string;
        previous: string;
    ...
    export interface LanguageAriaSettings {
    ...
    export interface ArrayStringNode {
        [index: string]: Node;
    }
     ...
     * @param settings DataTable settings object.
     */
    type FunctionExtTypeSettingsDetect = (data: any, settings: Settings) => string | null;
}

declare interface DataTablesStaticExt extends DTStaticExt {
    afnFiltering: Array<any>;
    sVersion: string;
}
...
declare type SettingsDT = DataTables.Settings & Config;
