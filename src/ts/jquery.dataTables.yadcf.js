...
var Yadcf = /** @class */ (function () {
    ...
    Yadcf.init = function (oTable, options_arg, params) {
        ...
        if ((0, jquery_1.default)(instance.selector).length === 1) {
            ...
            for (i; i < (0, jquery_1.default)(instance.selector).length; i++) {
                ...
                _a.setOptions(instance.selector, options_arg, params, oTable);
                _a.initAndBindTable(instance, selector, i, oTable);
            }
        ...
        keyUp = function () {
            ...
            if (((max instanceof Date) && (min instanceof Date) && (max >= min)) || !min || !max) {
                if (oTable.fnSettings().oFeatures.bServerSide !== true) {
                    ...
                    _a.saveStateSave(oTable, column_number, table_selector_jq_friendly, !min ? '' : minTmp, !max ? '' : maxTmp);
                    oTable.fnDraw();
                }
                else {
    ...
    Yadcf.textKeyUP = function (ev, table_selector_jq_friendly, column_number, clear) {
        ...
        keyUp = function (table_selector_jq_friendly, column_number, clear) {
            ...
            jquery_1.default.extend(jquery_1.default.fn, { dataTable: { ext: { iApiIndex: _a.oTablesIndex[table_selector_jq_friendly] } } });
            // Check checkboxes.
            ...
            if (clear === 'clear' || (0, jquery_1.default)(fixedPrefix + "#yadcf-filter-".concat(table_selector_jq_friendly, "-").concat(column_number)).val() === '') {
                if (clear === 'clear') {
                    ...
                    _a.resetExcludeRegexCheckboxes((0, jquery_1.default)(fixedPrefix + "#yadcf-filter-wrapper-".concat(table_selector_jq_friendly, "-").concat(column_number)));
                    _a.clearStateSave(oTable, column_number, table_selector_jq_friendly);
                    ...
                    if (_a.exGetColumnFilterVal(oTable, column_number) === '') {
                        return;
                    }
                }
                if (null_checked && columnObj.exclude) {
                    ...
                    _a.saveTextKeyUpState(oTable, table_selector_jq_friendly, column_number, regex_check_box, null_checked, exclude);
                    return;
                }
            ...
            _a.yadcfMatchFilter(oTable, (0, jquery_1.default)(fixedPrefix + "#yadcf-filter-".concat(table_selector_jq_friendly, "-").concat(column_number)).val(), regex_check_box ? 'regex' : columnObj.filter_match_mode, column_number_filter, exclude, column_number);
    ...
    Yadcf.exFilterColumn = function (table_arg, col_filter_arr, ajaxSource) {
        ...
        table_selector_jq_friendly = _a.generateTableSelectorJQFriendly2(table_arg);
    ...
    Yadcf.setProp = function (object, keys, val) {
        ...
        if (keys.length > 1) {
            ...
            _a.setProp(object[keys[0]], keys.slice(1), val);
            return;
        }
        object[keys[0]] = val;
    };
    ...
    Yadcf.yadcfMatchFilterString = function (table_arg, column_number, selected_value, filter_match_mode, multiple, exclude) {
        var case_insensitive = _a.getOptions(table_arg.selector)[column_number].case_insensitive, ret_val;
        if (!selected_value) {
            return '';
        }
    ...
    Yadcf.addRangeNumberAndSliderFilterCapability = function (table_selector_jq_friendly, fromId, toId, col_num, ignore_char, sliderMaxMin) {
        jquery_1.default.fn.dataTable.ext.afnFiltering.push(function (settingsDt, aData, iDataIndex, rowData) {
            var min, max, val, retVal = false, table_selector_jq_friendly_local = table_selector_jq_friendly, current_table_selector_jq_friendly = _a.generateTableSelectorJQFriendly2(settingsDt), ignore_char_local = ignore_char, column_data_type, html_data_type, columnObj, column_number_filter, valFrom, valTo, exclude_checked = false;
            if (table_selector_jq_friendly_local !== current_table_selector_jq_friendly) {
                return true;
            }
            columnObj = _a.getOptions(settingsDt.oInstance.selector)[col_num];
            ...
            column_number_filter = _a.calcColumnNumberFilter(settingsDt, col_num, table_selector_jq_friendly);
            if (rowData !== undefined) {
                ...
                if (columnObj.column_number_render) {
                    ...
                    if (typeof index === 'string' && typeof rowDataRender === 'object') {
                        var cellDataRender = columnObj.column_number_render(_a.getProp(rowDataRender, index), 'filter', rowData, meta);
                        _a.setProp(rowDataRender, index, (cellDataRender !== undefined && cellDataRender !== null) ? cellDataRender : _a.getProp(rowData, index));
                    }
                    else {
                ...
                if (columnObj.column_number_data !== undefined) {
                    ...
                    val = _a.dot2obj(aData, column_number_filter);
                }
                else {
    ...
    Yadcf.addCustomFunctionFilterCapability = function (table_selector_jq_friendly, filterId, col_num) {
        jquery_1.default.fn.dataTable.ext.afnFiltering.push(function (settingsDt, aData, iDataIndex, stateVal) {
            var filterVal = (0, jquery_1.default)('#' + filterId).val(), columnVal, retVal = false, table_selector_jq_friendly_local = table_selector_jq_friendly, current_table_selector_jq_friendly = _a.generateTableSelectorJQFriendly2(settingsDt), custom_func, column_number_filter;
            if (table_selector_jq_friendly_local !== current_table_selector_jq_friendly || filterVal === '-1') {
                return true;
            }
            column_number_filter = _a.calcColumnNumberFilter(settingsDt, col_num, table_selector_jq_friendly);
            columnVal = aData[column_number_filter] === '-' ? 0 : aData[column_number_filter];
            custom_func = _a.getOptions(settingsDt.oInstance.selector)[col_num].custom_func;
    ...
    Yadcf.addRangeDateFilterCapability = function (table_selector_jq_friendly, fromId, toId, col_num, date_format) {
        jquery_1.default.fn.dataTable.ext.afnFiltering.push(function (settingsDt, aData, iDataIndex, rowData) {
            ...
            if (rowData !== undefined && dataRenderFunc !== true) {
                if (columnObj.column_number_data !== undefined) {
                    column_number_filter = columnObj.column_number_data;
                    val = _a.dot2obj(rowData, column_number_filter);
                }
                else {
    ...
    Yadcf.addNullFilterCapability = function (table_selector_jq_friendly, col_num, isSelect) {
        jquery_1.default.fn.dataTable.ext.afnFiltering.push(function (settingsDt, aData, iDataIndex, rowData) {
            var val, retVal = false, table_selector_jq_friendly_local = table_selector_jq_friendly, current_table_selector_jq_friendly = _a.generateTableSelectorJQFriendly2(settingsDt), columnObj, column_number_filter, null_checked, exclude_checked;
            if (table_selector_jq_friendly_local !== current_table_selector_jq_friendly) {
                return true;
            }
            columnObj = _a.getOptions(settingsDt.oInstance.selector)[col_num];
            ...
            if (rowData !== undefined) {
                ...
                if (columnObj.column_number_render) {
                    ...
                    if (typeof index === 'string' && typeof rowDataRender === 'object') {
                        var cellDataRender = columnObj.column_number_render(_a.getProp(rowDataRender, index), 'filter', rowData, meta);
                        _a.setProp(rowDataRender, index, (cellDataRender !== undefined) ? cellDataRender : _a.getProp(rowData, index));
                    }
                    else {
                        var cellDataRender = columnObj.column_number_render(rowDataRender[index], 'filter', rowData, meta);
                ...
                if (columnObj.column_number_data !== undefined) {
                    column_number_filter = columnObj.column_number_data;
                    val = _a.getProp(aData, column_number_filter.toString());
                }
                else {
                    val = aData[column_number_filter];
                }
    ...
    Yadcf.addRangeNumberFilter = function (filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, filter_default_label, ignore_char) {
        ...
        filterActionFn = function (tableSel) {
            return function (event) {
                _a.rangeNumberKeyUP(tableSel, event);
            };
        ...
        if (filter_reset_button_text !== false) {
            (0, jquery_1.default)(filter_selector_string_tmp).append(this.makeElement('<button>', {
                ...
                onclick: function (colNo, tableSel) {
                    return function (event) {
                        _a.stopPropagation(event);
                        _a.rangeClear(tableSel, event, colNo);
                        return false;
                    };
        ...
        if (columnObj.externally_triggered_checkboxes_text && typeof columnObj.externally_triggered_checkboxes_function === 'function') {
            (0, jquery_1.default)(filter_selector_string_tmp).append(this.makeElement('<button>', {
                ...
                onmousedown: _a.stopPropagation,
                onclick: _a.stopPropagation,
        ...
        if (columnObj.null_check_box === true) {
            null_str = this.makeElement('<span>', {
                ...
                onclick: function (colNo, tableSel) {
                    return function (event) {
                        _a.stopPropagation(event);
                        _a.nullChecked(event, tableSel, colNo);
                    };
                }(column_number, table_selector_jq_friendly)
            }));
            if (oTable.fnSettings().oFeatures.bServerSide !== true) {
    ...
    Yadcf.addRangeDateFilter = function (filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, filter_default_label, date_format) {
        ...
        filterActionFn = function (tableSel) {
            return function (event) {
                _a.rangeDateKeyUP(tableSel, date_format, event);
            };
        }(table_selector_jq_friendly);
        if (columnObj.externally_triggered === true) {
            filterActionFn = function () { };
    ...
    Yadcf.addDateFilter = function (filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, filter_default_label, date_format) {
        ...
        filterActionFn = function (tableSel) {
            return function (event) {
                _a.dateKeyUP(table_selector_jq_friendly, date_format, event);
            };
        }(table_selector_jq_friendly);
        if (columnObj.externally_triggered === true) {
            filterActionFn = function () { };
        ...
        (0, jquery_1.default)(filter_selector_string).append(this.makeElement('<input>', {
            onkeydown: _a.preventDefaultForEnter,
        ...
        if (filter_reset_button_text !== false) {
            (0, jquery_1.default)(filter_selector_string_tmp).append(this.makeElement('<button>', {
                ...
                onclick: function (tableSel) {
                    return function (event) {
                        _a.stopPropagation(event);
                        _a.dateSelectSingle(tableSel, _a.eventTargetFixUp(event).target, 'clear');
                        return false;
                    };
                }(table_selector_jq_friendly),
                class: 'yadcf-filter-reset-button ' + columnObj.reset_button_style_class,
        ...
        if (isFinite(min_val) && isFinite(max_val) && isFinite(min_state_val) && isFinite(max_state_val)) {
            ...
            sliderObj = {
                ...
                create: function (event, ui) {
                    _a.rangeNumberSldierDrawTips(min_state_val, max_state_val, min_tip_id, max_tip_id, table_selector_jq_friendly, column_number);
                },
                slide: slideFunc,
                change: changeFunc
            };
            ...
            if (filter_reset_button_text !== false) {
                (0, jquery_1.default)(filter_selector_string_tmp).append(this.makeElement('<button>', {
                    ...
                    onclick: function (tableSel) {
                        return function (event) {
                            _a.stopPropagation(event);
                            _a.rangeNumberSliderClear(tableSel, event);
                            return false;
                        };
                    }(table_selector_jq_friendly),
        ...
        for (j = 0; j < data_length; j++) {
            if (columnObj.column_data_type === 'html') {
                ...
                if (data[j]._aFilterData) {
                    ...
                    console.log("Looks like you missing 'column_data_render' function for the column ".concat(column_number_filter));
                }
                    ...
                    if (columnObj.column_number_render) {
                        ...
                        column_data_render_1.forEach(function (data, index) {
                            ...
                            if (typeof indexData === 'string' && typeof column_data_render_1 === 'object') {
                                var cellDataRender = columnObj.column_number_render(_a.getProp(column_data_render_1, indexData), 'filter', column_data, meta);
                                _a.setProp(column_data_render_1, indexData, (cellDataRender !== undefined && cellDataRender !== null) ? cellDataRender : _a.getProp(column_data, indexData));
                            }
                            else {
                    ...
                    if (columnObj.filter_type === 'select' || columnObj.filter_type === 'custom_func') {
                        ...
                        if (columnObj.filter_type === 'select') {
                            filterActionFn = function (colNo, tableSel) {
                                return function (event) {
                                    _a.doFilter(this, tableSel, colNo, filter_match_mode);
                                };
                            }(column_number, table_selector_jq_friendly);
                            if (columnObj.externally_triggered === true) {
                                filterActionFn = function () { };
                            ...
                            if (filter_reset_button_text !== false) {
                                (0, jquery_1.default)(filter_selector_string).find('.yadcf-filter').after(this_1.makeElement('<button>', {
                                    ...
                                    onclick: function (colNo, tableSel) {
                                        return function (event) {
                                            _a.doFilter('clear', tableSel, colNo);
                                            return false;
                                        };
                                    }(column_number, table_selector_jq_friendly),
                                    class: 'yadcf-filter-reset-button ' + columnObj.reset_button_style_class,
                            ...
                            if (columnObj.exclude === true) {
                                exclude_str = this_1.makeElement('<span>', {
                                    ...
                                    onclick: function (colNo, tableSel) {
                                        return function (event) {
                                            _a.stopPropagation(event);
                                            _a.doFilter('exclude', tableSel, colNo, filter_match_mode);
                                        };
                                    }(column_number, table_selector_jq_friendly)
                                }));
                            }
                            ...
                            filterActionFn = function (colNo, tableSel) {
                                return function (event) {
                                    _a.doFilterCustomDateFunc(this, tableSel, colNo);
                                };
                            }(column_number, table_selector_jq_friendly);
                            if (columnObj.externally_triggered === true) {
                                filterActionFn = function () { };
                            ...
                            if (filter_reset_button_text !== false) {
                                (0, jquery_1.default)(filter_selector_string).find('.yadcf-filter').after(this_1.makeElement('<button>', {
                                    ...
                                    onclick: function (colNo, tableSel) {
                                        return function (event) {
                                            _a.stopPropagation(event);
                                            _a.doFilterCustomDateFunc('clear', tableSel, colNo);
                                            return false;
                                        };
                                    }(column_number, table_selector_jq_friendly),
                                    class: 'yadcf-filter-reset-button ' + columnObj.reset_button_style_class,
                        ...
                        if (columnObj.filter_type === 'multi_select') {
                            filterActionFn = function (colNo, tableSel) {
                                return function (event) {
                                    _a.doFilterMultiSelect(this, tableSel, colNo, filter_match_mode);
                                };
                            }(column_number, table_selector_jq_friendly);
                            if (columnObj.externally_triggered === true) {
                                filterActionFn = function () { };
                        ...
                        filterActionFn = function (tableSel) {
                            return function (event) {
                                _a.autocompleteKeyUP(tableSel, event);
                            };
                        }(table_selector_jq_friendly);
                        if (columnObj.externally_triggered === true) {
                            filterActionFn = function () { };
                        ...
                        if (filter_reset_button_text !== false) {
                            (0, jquery_1.default)(filter_selector_string).find('.yadcf-filter').after(this_1.makeElement('<button>', {
                                ...
                                onclick: function (colNo, tableSel) {
                                    return function (event) {
                                        _a.stopPropagation(event);
                                        _a.doFilterAutocomplete('clear', tableSel, colNo);
                                        return false;
                                    };
                                }(column_number, table_selector_jq_friendly),
                                class: 'yadcf-filter-reset-button ' + columnObj.reset_button_style_class,
                        ...
                        filterActionFn = function (colNo, tableSel) {
                            ...
                            return function (event) {
                                _a.textKeyUP(event, tableSel, colNo);
                            };
                        }(column_number, table_selector_jq_friendly);
                        if (columnObj.externally_triggered === true) {
                            filterActionFn = function () { };
                        ...
                        if (filter_reset_button_text !== false) {
                            (0, jquery_1.default)(filter_selector_string).find('.yadcf-filter').after(this_1.makeElement('<button>', {
                                ...
                                onclick: function (colNo, tableSel) {
                                    ...
                                    return function (event) {
                                        _a.stopPropagation(event);
                                        _a.textKeyUP(event, tableSel, colNo, 'clear');
                                        return false;
                                    };
                                }(column_number, table_selector_jq_friendly),
                                class: 'yadcf-filter-reset-button ' + columnObj.reset_button_style_class,
    ...
    Yadcf.scrollXYHandler = function (oTable, table_selector) {
        var $tmpSelector, filters_position = (0, jquery_1.default)(document).data("".concat(table_selector, "_filters_position")), table_selector_jq_friendly = this.generateTableSelectorJQFriendly2(oTable);
        if (filters_position === 'thead') {
        ...
        if (oTable.fnSettings().oScroll.sX !== '' || oTable.fnSettings().oScroll.sY !== '') {
            ...
            $tmpSelector.addClass("yadcf-datatables-table-".concat(table_selector_jq_friendly));
        }
    };
    ...
    Yadcf.initAndBindTable = function (oTable, table_selector, index, pTableDT) {
        ...
        if (this.isDOMSource(oTable)) {
            ...
            if (this.getOptions(table_selector_tmp)[this.firstFromObject(this.getOptions(table_selector_tmp))].cumulative_filtering === true) {
                ...
                (0, jquery_1.default)(document).off('search.dt', oTable.selector).on('search.dt', oTable.selector, function (e, settings, json) {
                    ...
                    _this.appendFilters(oTable, _a.getOptions(table_selector_tmp), oTable.selector, settings);
                });
            }
        }
        else {
            ...
            if (this.yadcfVersionCheck('1.10')) {
                (0, jquery_1.default)(document).off('xhr.dt', oTable.selector).on('xhr.dt', oTable.selector, function (e, settings, json) {
                    var col_num, column_number_filter, table_selector_jq_friendly = _this.generateTableSelectorJQFriendly2(oTable);
                    if (!json) {
                        console.log('datatables `xhr.dt` event came back with null as data (nothing for yadcf to do with it).');
                        return;
                    }
                    if (settings.oSavedState !== null) {
                        _this.initColReorder2(settings, table_selector_jq_friendly);
                    }
                    for (col_num in _this.getOptions(settings.oInstance.selector)) {
                        if (_this.getOptions(settings.oInstance.selector).hasOwnProperty(col_num)) {
                            if (json["yadcf_data_".concat(col_num)] !== undefined) {
                                column_number_filter = col_num;
                                if (settings.oSavedState !== null && _this.plugins[table_selector_jq_friendly] !== undefined) {
                                    column_number_filter = _this.plugins[table_selector_jq_friendly].ColReorder[col_num];
                                }
                                _this.getOptions(settings.oInstance.selector)[col_num].data = json["yadcf_data_".concat(column_number_filter)];
                            }
                        }
                    }
                    if (_this.dTXhrComplete !== undefined) {
                        _this.yadcfDelay(function () {
                            _this.dTXhrComplete();
                            _this.dTXhrComplete = undefined;
                        }, 100);
                    }
                });
            }
        ...
        if (this.yadcfVersionCheck('1.10')) {
            (0, jquery_1.default)(document).off('stateLoaded.dt', oTable.selector).on('stateLoaded.dt', oTable.selector, function (event, settings) {
                var args = _a.getOptions(settings.oInstance.selector);
                var columnObjKey;
                for (columnObjKey in args) {
                    if (args.hasOwnProperty(columnObjKey)) {
                        ...
                        var table_selector_jq_friendly_1 = _this.generateTableSelectorJQFriendly2(oTable);
                        _this.loadFromStateSaveTextFilter(oTable, settings, columnObj, table_selector_jq_friendly_1, column_position, column_number);
                    }
                }
            });
            (0, jquery_1.default)(document).off('draw.dt', oTable.selector).on('draw.dt', oTable.selector, function (event, settings) {
                _this.appendFilters(oTable, _this.getOptions(settings.oInstance.selector), settings.oInstance.selector, settings);
            });
            (0, jquery_1.default)(document).off('column-visibility.dt', oTable.selector).on('column-visibility.dt', oTable.selector, function (e, settings, col_num, state) {
                var obj = {}, columnsObj = _this.getOptions(settings.oInstance.selector);
                // @ts-expect-error
                if (state === true && settings._oFixedColumns === undefined) {
                    if (_this.plugins[table_selector_jq_friendly] !== undefined &&
                        _this.plugins[table_selector_jq_friendly].ColReorder !== undefined) {
                        col_num = _this.plugins[table_selector_jq_friendly].ColReorder[col_num];
                    }
                    else if (settings.oSavedState && settings.oSavedState.ColReorder !== undefined) {
                        col_num = settings.oSavedState.ColReorder[col_num];
                    }
                    obj[col_num] = _this.getOptions(settings.oInstance.selector)[col_num];
                    if (obj[col_num] !== undefined) {
                        obj[col_num].column_number = col_num;
                        if (obj[col_num] !== undefined) {
                            _this.appendFilters(_this.oTables[_this.generateTableSelectorJQFriendly2(settings)], obj, settings.oInstance.selector, settings);
                        }
                    }
                }
                // @ts-expect-error
                else if (settings._oFixedColumns !== undefined) {
                    _this.appendFilters(_this.oTables[_this.generateTableSelectorJQFriendly2(settings)], columnsObj, settings.oInstance.selector, settings);
                }
            });
            (0, jquery_1.default)(document).off('column-reorder.dt', oTable.selector).on('column-reorder.dt', oTable.selector, function (e, settings, json) {
                var table_selector_jq_friendly = _this.generateTableSelectorJQFriendly2(oTable);
                _this.initColReorderFromEvent(table_selector_jq_friendly);
            });
            (0, jquery_1.default)(document).off('destroy.dt', oTable.selector).on('destroy.dt', oTable.selector, function (e, ui) {
                _this.removeFilters(oTable);
                _this.removeFilters(ui.oInstance);
            });
        }
        else {
            (0, jquery_1.default)(document).off('draw', oTable.selector).on('draw', oTable.selector, function (e, settings) {
                _this.appendFilters(oTable, _this.getOptions(settings.oInstance.selector), settings.oInstance.selector, settings);
            });
            (0, jquery_1.default)(document).off('destroy', oTable.selector).on('destroy', oTable.selector, function (e, ui) {
                _this.removeFilters(oTable);
                _this.removeFilters(ui.oInstance.selector);
            });
        }
        if (oTable.fnSettings().oFeatures.bStateSave === true) {
            if (this.yadcfVersionCheck('1.10')) {
        ...
        jquery_1.default.extend(jquery_1.default.fn, {
            yadcf: function (options_arg, params) {
                ...
                if ((0, jquery_1.default)(this.selector).length === 1) {
                    _a.setOptions(this.selector, options_arg, params);
                    _a.initAndBindTable(this, this.selector, 0);
                }
                else {
                    for (i; i < (0, jquery_1.default)(this.selector).length; i++) {
                        ...
                        _a.setOptions(this.selector, options_arg, params);
                        _a.initAndBindTable(this, selector, i);
                    }
                    jquery_1.default.fn.dataTable.ext.iApiIndex = 0;
                }
                if (params.onInitComplete !== undefined) {
            ...
            case 'text':
                (0, jquery_1.default)(filter_selector_string).append(this.makeElement('<input>', {
                    ...
                    onkeyup: function (colNo) {
                        return function (event) {
                            _a.stopPropagation(event);
                            _a.textKeyUpMultiTables(tablesSelectors, event, colNo);
                            return false;
                        };
                    }(column_number_str),
                }));
                if (filterOptions.filter_reset_button_text !== false) {
                    (0, jquery_1.default)(filter_selector_string).find('.yadcf-filter').after(this.makeElement('<button>', {
                        ...
                        onclick: function (colNo) {
                            return function (event) {
                                _a.stopPropagation(event);
                                _a.textKeyUpMultiTables(tablesSelectors, event, colNo, 'clear');
                                return false;
                            };
                        }(column_number_str),
                    ...
                    for (tableTmpArrIndex = 0; tableTmpArrIndex < tableTmpArr.length; tableTmpArrIndex++) {
                        ...
                        if (this.isDOMSource(tableTmp)) {
                            ...
                            (0, jquery_1.default)(document).off('draw.dt', '#' + tablesArray[tableTmpArrIndex].table().node().id).on('draw.dt', '#' + tablesArray[tableTmpArrIndex].table().node().id, function (event, ui) {
                                ...
                                for (column_number_index = 0; column_number_index < [columnsTmpArr].length; column_number_index++) {
                                    filterOptions.column_number = columnsTmpArr[column_number_index];
                                    filterOptions.data = filterOptions.data.concat(_this.parseTableColumn(tableTmp, filterOptions, table_selector_jq_friendly, ui));
                                }
                                filterOptions.column_number = columnsTmpArr;
                                filterOptions.data = _this.sortColumnData(filterOptions.data, filterOptions);
                                ...
                                if (filterOptions.select_type !== undefined) {
                                    _this.initializeSelectPlugin(filterOptions.select_type, (0, jquery_1.default)('#' + filterOptions.filter_container_id + ' select'), filterOptions.select_type_options);
                                    if (filterOptions.cumulative_filtering === true && filterOptions.select_type === 'chosen') {
                                        _this.refreshSelectPlugin(filterOptions, (0, jquery_1.default)('#' + filterOptions.filter_container_id + ' select'));
                                    }
                                }
                            });
                        }
                ...
                if (filterOptions.filter_type === 'select') {
                    (0, jquery_1.default)(filter_selector_string).append(this.makeElement('<select>', {
                        ...
                        onchange: function (colNo) {
                            return function (event) {
                                _a.stopPropagation(event);
                                _a.doFilterMultiTables(tablesSelectors, event, colNo);
                            };
                        }(column_number_str),
                        onmousedown: _a.stopPropagation,
                        onclick: _a.stopPropagation,
                    ...
                    (0, jquery_1.default)(filter_selector_string).append(this.makeElement('<select>', {
                        ...
                        onchange: function (colNo) {
                            return function (event) {
                                _a.stopPropagation(event);
                                _a.doFilterMultiTablesMultiSelect(tablesSelectors, event, colNo);
                            };
                        }(column_number_str),
                        onmousedown: this.stopPropagation,
                        onclick: this.stopPropagation,
                    ...
                    if (filterOptions.filter_reset_button_text !== false) {
                        (0, jquery_1.default)(filter_selector_string).find('.yadcf-filter').after(this.makeElement('<button>', {
                            ...
                            onclick: function (colNo) {
                                return function (event) {
                                    _a.stopPropagation(event);
                                    _a.doFilterMultiTables(tablesSelectors, event, colNo, true);
                                    return false;
                                };
                            }(column_number_str),
                    ...
                    if (filterOptions.filter_reset_button_text !== false) {
                        (0, jquery_1.default)(filter_selector_string).find('.yadcf-filter').after(this.makeElement('<button>', {
                            ...
                            onclick: function (colNo) {
                                return function (event) {
                                    _a.stopPropagation(event);
                                    _a.doFilterMultiTablesMultiSelect(tablesSelectors, event, colNo, true);
                                    return false;
                                };
                            }(column_number_str),
                            class: "yadcf-filter-reset-button ".concat(filterOptions.reset_button_style_class),
    ...
    Yadcf.exInternalFilterColumnAJAXQueue = function (table_arg, col_filter_arr) {
        return function () {
            _a.exFilterColumn(table_arg, col_filter_arr, true);
        };
    };
    ...
    Yadcf.autocompleteSelect = function (event, ui) {
        ...
        event = _a.eventTargetFixUp(event);
        ...
        _a.doFilterAutocomplete(ui.item, table_selector_jq_friendly, col_num, filter_match_mode);
    };
    return Yadcf;
}());
